...
import com.boc.lfj.httpdemo.powerrv.demo.simple.RefreshActivity;
...
public class GuideActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.bt_choice, R.id.bt_customer, R.id.bt_drag, R.id.bt_grid, R.id.bt_normal, R.id.bt_refresh,R.id.bt_simple})
    void click(View v) {
        Intent intent = null;
        switch (v.getId()) {
            case R.id.bt_normal:
